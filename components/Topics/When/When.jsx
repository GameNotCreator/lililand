    ...
    <div className='h-full bg-base-200'>
      <div className="hero min-h-screen">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            <h1 className="text-5xl font-bold">Quand le faisons-nous ?</h1>
            <p className="py-6">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
            <Link href="#timeline" className='btn btn-neutral'>Voir notre timeline</Link>
          </div>
        </div>
      </div>
      <br/>
      <div className="divider" id="timeline"></div>
      <br/><br/><br/><br/><br/>
      <h1 className="text-5xl font-bold text-center">Timeline</h1>
      <br/>
      <ul  className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical min-h-screen">
        <li>
